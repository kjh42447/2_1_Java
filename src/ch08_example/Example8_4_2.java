//Example 8_4_1을 보완하여 길이뿐만 아니라 온도, 무게에 대해서도 창을 추가하라.
...
public class Example8_4_2 {

	public static void main(String[] args) {
		LengthConvertor f1 = new LengthConvertor();
		TemperatureConvertor f2 = new TemperatureConvertor();
		WeightConvertor f3 = new WeightConvertor();
	}
